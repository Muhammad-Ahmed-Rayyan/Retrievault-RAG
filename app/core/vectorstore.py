...
def build_vectorstore(chunks: List[Document], collection_name: str = "documind") -> Chroma:
    ...
    Args:
        chunks: Pre-split Document chunks to embed and store.
        collection_name: Logical name for this Chroma collection.
...
def add_documents_to_vectorstore(vectorstore: Chroma, chunks: List[Document]) -> None:
    ...
    e.g. when a user uploads another document after the first session.
    """
